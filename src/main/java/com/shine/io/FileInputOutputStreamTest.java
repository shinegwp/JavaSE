...
* @version 创建时间：2018年8月9日 下午7:50:27
* @describe  
* 1.流的分类：
* 按照数据流向的不同：输入流  输出流
...
public class FileInputOutputStreamTest {
	...
	public void testFileInputOutputStream() {
		...
		File file2 = new File("src/main/java/com/shine/io/2.jpg");
		// 2.提供相应的流
		FileInputStream fis = null;
		FileOutputStream fos = null;
		try {
	...
	public void testFileOutputStream() {
		...
		File file = new File("src/main/java/com/shine/io/gwp1.txt");
	...
	public void testFileInputStream3() { // abcdefgcde
		...
		try {
			...
			byte[] b = new byte[5];// 读取到的数据要写入的数组。读取b.length个字节的数据为字节数组
